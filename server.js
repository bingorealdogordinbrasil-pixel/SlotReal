...
app.post('/api/spin', async (req, res) => {
    try {
        ...
        // RESETA AS BETS SÓ AQUI NO BANCO
...
app.post('/gerar-pix', (req, res) => {
    ...
    const postData = JSON.stringify({
        ...
        payer: { email: `${cleanUser}@gmail.com`, first_name: cleanUser, last_name: "Cliente", identification: { type: "CPF", number: "19119119100" } }
    });
    const options = {
